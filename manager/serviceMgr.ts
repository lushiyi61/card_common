...
//   SERVER_REQUEST,
//   ServerRes,
// } from "../findserv/readme/httpApi_find";
...
//   const findServer = config.findServer;
//   await Promise.all(
...
//           findServer.server_ip,
//           findServer.server_port,
//           SERVER_REQUEST.FIND,
//           findreq
//         );
//         if (result.data) {
...
//   );
//   setTimeout(
//     server_manager_start_async,
//     config.find_server.tick_time,
//     server_types
//   );
// }
...
// export async function post_to_server_async(
//   server_type: string,
//   cmd: string,
//   params: any
// ): Promise<HttpReturn> {
